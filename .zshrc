...
export PATH=$PATH:/home/jellybean/.cargo/bin
export PATH=$PATH:/home/jellybean/go/bin
export PATH="/home/jellybean/.bun/bin:$PATH"
...
alias TL='java -jar ~/software/TLauncher.jar'

# oh my oh-my-posh

eval "$(oh-my-posh init zsh --config ~/.poshthemes/arch.omp.json)"
